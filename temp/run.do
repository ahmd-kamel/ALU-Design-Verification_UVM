...
log /* -r
run -all
coverage exclude -src ../../tinyalu_dut/single_cycle.vh -line 18 -code s
coverage exclude -src ../../tinyalu_dut/single_cycle.vh -scope /top/DUT/add_and_xor -line 18 -code b
